...
| 2026-04-03 | Combined: allocation elimination + batch clear_learnt + state pre-filter. End-to-end verification on full n=26 run. | Three changes working together: (1) reusable buffers for all conflict analysis allocations, (2) batch clear_learnt every 8 instead of 1, (3) skip non-MAYBE terms in propagate_quad_pb. | Full n=26: 869s → 667s (**-23.2%**). SAT-heavy microbenchmark: 18.95s → 16.41s (**-13.4%**). Phase C throughput: ~100 → ~130 pairs/s. |
