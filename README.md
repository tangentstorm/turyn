...
- `docs/TTC-AUDIT.md` — **read before trusting any `covered` or TTC number.** Per-mode coverage-honesty audit, what was fixed, and `check_coverage` for verifying a run against the published catalogue.
